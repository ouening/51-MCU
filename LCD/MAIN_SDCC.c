 ...
 * @brief	电机编码器测速设计程序,SDCC版本，KEIL C版本见另一个文件
 ...
 * @description
	 ...
	 测速原理：
      ...
      程序开始-> |	   定时满1s|
	       ...
	       * @attention: 	
				 0.SDCC版本的需要注意引脚定义和KEIL C不一样，读者可以自己查看手册和头文件，本人也了解不多
...
#include <mcs51reg.h>	// SDCC引入51的头文件
#include <string.h>

#define m1 P2_0		//PWM信号
#define m2 P2_1

#define key0 P3_3	//反接制动
#define key1 P3_4	//方向切换及启动
#define key2 P3_5	//能耗制动
#define key3 P3_6	//加速
#define key4 P3_7	//减速

#define BUTTON0 P3_2	//外部中断0
...
//注意SDCC的中断处理函数要声明，关键字interrupt前面要加双下划线，而KEIL C 的（可以）不用函数声明
void timer0() __interrupt 1;		
void timer1() __interrupt 3;

void extern_int0(void) __interrupt 0;
void extern_int1(void) __interrupt 2;
...
void extern_int0(void) __interrupt 0 	//外部中断0
{
   //led = ~led;
   num ++;	// 外部中断计数
}
...
/**
 * @brief	外部中断1，控制反接制动，反接约1.5s（软件延时）
 *
 */
 
void extern_int1(void) __interrupt 2	//外部中断1
{
